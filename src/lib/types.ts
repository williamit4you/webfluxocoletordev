...
export type Step={id?:string;name:string;description?:string;type:number;order:number;assignedUserId?:string|null;fields:Field[];apiConfig?:StepApiConfig|null};
